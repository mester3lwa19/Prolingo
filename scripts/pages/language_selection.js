document.addEventListener("DOMContentLoaded", function () {
  ...
  const languages = [
    ...
    {
      name: "React JS",
      icon: "../assets/images/vscode-icons_file-type-reactjs.svg",
    },
    { name: "Ruby", icon: "../assets/images/devicon_ruby.svg" },
    {
      name: "Typescript",
      icon: "../assets/images/material-icon-theme_typescript.svg",
    },
  ...
  function filterLanguages(searchTerm) {
    ...
    if (!hasVisibleCards) {
      if (!noResultsMsg) {
        ...
        languageGrid.parentNode.insertBefore(
          noResultsMsg,
          languageGrid.nextSibling
        );
      }
  ...
  function loadSavedPreferences() {
    ...
    if (savedSkillLevel) {
      const radioButton = document.querySelector(
        `input[name="skill-level"][value="${savedSkillLevel}"]`
      );
